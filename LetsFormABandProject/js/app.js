$(() => {
  ...
  // ======================ROW 1============================
  let row1 = [$('img').eq(0), $('img').eq(8), $('img').eq(16), $('img').eq(24), $('img').eq(32), $('img').eq(40), $('img').eq(48), $('img').eq(56)];
  // ======================ROW 2====================
  let row2 = [$('img').eq(1), $('img').eq(9), $('img').eq(17), $('img').eq(25), $('img').eq(33), $('img').eq(41), $('img').eq(49), $('img').eq(57)];
  // // ======================ROW 3==================
  let row3 = [$('img').eq(2), $('img').eq(10), $('img').eq(18), $('img').eq(26), $('img').eq(34), $('img').eq(42), $('img').eq(50), $('img').eq(58)];
  // ======================ROW 4===========================
  let row4 = [$('img').eq(3), $('img').eq(11), $('img').eq(19), $('img').eq(27), $('img').eq(35), $('img').eq(43), $('img').eq(51), $('img').eq(59)];
  // ======================ROW 5=====================
  let row5 = [$('img').eq(4), $('img').eq(12), $('img').eq(20), $('img').eq(28), $('img').eq(36), $('img').eq(44), $('img').eq(52), $('img').eq(60)];
  // ======================ROW 6======================
  let row6 = [$('img').eq(5), $('img').eq(13), $('img').eq(21), $('img').eq(29), $('img').eq(37), $('img').eq(45), $('img').eq(53), $('img').eq(61)];
  // ======================ROW 7=====================
  let row7 = [$('img').eq(6), $('img').eq(14), $('img').eq(22), $('img').eq(30), $('img').eq(38), $('img').eq(46), $('img').eq(54), $('img').eq(62)];
  // ======================ROW 8===================
